{
        ...
        // displays the stream from the camera, and then
        //creates an imagecapture object using that video stream
        const gotStream = stream => {
                mediaStream = stream;
                video.srcObject = stream;
                imageCapture = new imageCapture(steam.getVideoTracks() [0] );
        };
        ...
        const getPicture = () => {
                ...
                imageCapture.takePhoto()
                        ...
                        .catch((error) => {console.log('takePhoto()', error)});
        };
